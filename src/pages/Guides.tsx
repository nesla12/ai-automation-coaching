          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {filteredGuides.map((guide) => (
              <Link
                key={guide.id}
                to={`/guides/${guide.id}`}
                className="group relative block submenu-highlight rounded-xl"
              >
                <motion.div
                  whileHover={{ y: -8 }}
                  whileTap={{ scale: 0.98 }}
                ...
                >
                <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary rounded-xl opacity-0 group-hover:opacity-10 blur-lg transition-opacity duration-300" />
                <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-xl shadow-lg group-hover:shadow-2xl group-hover:scale-[1.02] transition-all duration-300 overflow-hidden z-10 h-full">
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="relative">
                      ...
                      <Sparkles className="w-5 h-5 text-primary opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out transform group-hover:rotate-12 relative z-10" />
                    </div>
                  </div>
